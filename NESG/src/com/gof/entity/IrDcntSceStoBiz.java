...
@Entity
@Table(name ="IR_DCNT_SCE_STO_BIZ")
@NoArgsConstructor
@Getter
@Setter
@ToString
@SequenceGenerator (name = "IR_DCNT_SCE_STO_BIZ_SEQ_GEN",sequenceName = "IR_DCNT_SCE_STO_BIZ_SEQ",initialValue = 1, allocationSize = 1)
public class IrDcntSceStoBiz extends BaseEntity implements Serializable, EntityIdentifier {
