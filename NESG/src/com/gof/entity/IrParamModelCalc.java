...
@Entity
@Table(name ="IR_PARAM_MODEL_CALC")
@NoArgsConstructor
@Getter
@Setter
@EqualsAndHashCode(callSuper = false)
@ToString
@SequenceGenerator (name = "IR_PARAM_MODEL_CALC_SEQ_GEN",sequenceName = "IR_PARAM_MODEL_CALC_SEQ",initialValue = 1, allocationSize = 1)
public class IrParamModelCalc  extends BaseEntity implements Serializable, EntityIdentifier {
	
	private static final long serialVersionUID = 3998120244491066027L;

	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "IR_PARAM_MODEL_CALC_SEQ")
	@Column (name = "SID")
	@Id
	private long id;
